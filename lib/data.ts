...
export const products: Product[] = [
  // CÀ PHÊ
  { id: "phe-xiu-vani", name: "PHÊ XỈU VANI", price: 50000, category: "ca-phe" },
  { id: "phe-espresso-colom", name: "PHÊ ESPRESSO (Hạt Colom, Ethi)", price: 50000, category: "ca-phe" },
  { id: "phe-espresso-ro", name: "PHÊ ESPRESSO (Hạt Ro, Ara)", price: 45000, category: "ca-phe" },
  { id: "phe-latte-colom", name: "PHÊ LATTE (Hạt Colom, Ethi)", price: 59000, category: "ca-phe" },
  { id: "phe-latte-ro", name: "PHÊ LATTE (Hạt Ro, Ara)", price: 54000, category: "ca-phe" },
  { id: "phe-cappu-ro", name: "PHÊ CAPPU (Hạt Ro, Ara)", price: 54000, category: "ca-phe" },
  { id: "phe-cappu-colom", name: "PHÊ CAPPU (Hạt Colom, Ethi)", price: 59000, category: "ca-phe" },
  { id: "phe-ame-ro", name: "PHÊ AME (Hạt Ro, Ara)", price: 45000, category: "ca-phe" },
  { id: "phe-ame-colom", name: "PHÊ AME (Hạt Colom, Ethi)", price: 50000, category: "ca-phe" },
  { id: "phe-nau", name: "PHÊ NÂU", price: 39000, category: "ca-phe" },
  { id: "phe-den", name: "PHÊ ĐEN", price: 39000, category: "ca-phe" },
  { id: "da-lat", name: "ĐÀ LẠT", price: 45000, category: "ca-phe" },

  // SYPHON
  { id: "phan-xi-pang-long-nhan", name: "PHAN XI PĂNG LONG NHÃN", price: 0, category: "syphon" },
  { id: "mat-nhan-o-long", name: "Mật Nhãn - Ô Long Long Nhãn Sữa", price: 0, category: "syphon" },
  { id: "phong-lan-la", name: "Phong Lan (size La)", price: 69000, category: "syphon" },
  { id: "o-long-nhai-sua-la", name: "Ô Long Nhài Sữa (size La)", price: 69000, category: "syphon" },
  { id: "o-long-sua-la", name: "Ô Long Sữa Phê La (size La)", price: 69000, category: "syphon" },
  { id: "phong-lan", name: "Phong Lan (Ô Long Vani Sữa)", price: 54000, category: "syphon" },
  { id: "o-long-sua", name: "Ô LONG SỮA PHÊ LA", price: 54000, category: "syphon" },
  { id: "o-long-nhai-sua", name: "Ô LONG NHÀI SỮA", price: 54000, category: "syphon" },

  // FRENCH PRESS
  { id: "gam-o-long-vai", name: "GẤM - Ô LONG VẢI CHANH VÀNG", price: 0, category: "french-press" },
  { id: "lua-dao-la", name: "LỤA ĐÀO (size La)", price: 69000, category: "french-press" },
  { id: "lua-dao", name: "LỤA ĐÀO (size Phê)", price: 54000, category: "french-press" },
  { id: "tra-vo-ca-phe-la", name: "Trà Vỏ Cà Phê (size La)", price: 69000, category: "french-press" },
  { id: "o-long-dao-hong-la", name: "Ô LONG ĐÀO HỒNG (Size La)", price: 69000, category: "french-press" },
  { id: "tra-vo-ca-phe", name: "TRÀ VỎ CÀ PHÊ", price: 54000, category: "french-press" },

  // MOKA POT
  { id: "tam-la", name: "Tấm (size La)", price: 69000, category: "moka-pot" },
  { id: "khoi-blao-la", name: "Khói B'Lao (size La)", price: 69000, category: "moka-pot" },
  { id: "khoi-blao", name: "KHÓI B'LAO", price: 54000, category: "moka-pot" },
  { id: "tam", name: "TẤM", price: 54000, category: "moka-pot" },

  // COLD BREW
  { id: "sua-chua-bong-buoi", name: "SỮA CHUA BÒNG BƯỞI", price: 0, category: "cold-brew" },
  { id: "bong-buoi-o-long", name: "BÒNG BƯỞI - Ô LONG BƯỞI NHA ĐAM", price: 64000, category: "cold-brew" },
  { id: "lang-biang-la", name: "Lang Biang (size La)", price: 69000, category: "cold-brew" },
  { id: "si-mo-la", name: "SI MƠ - COLD BREW Ô LONG MƠ ĐÀO (size La)", price: 64000, category: "cold-brew" },
  { id: "lang-biang", name: "LANG BIANG", price: 54000, category: "cold-brew" },

  // Ô LONG MATCHA
  { id: "matcha-phan-xi-pang", name: "MATCHA PHAN XI PĂNG", price: 64000, category: "o-long-matcha" },
  { id: "matcha-coco-latte", name: "MATCHA COCO LATTE", price: 59000, category: "o-long-matcha" },
  ...
  { id: "plus-mat-nhan", name: "Plus - Mật Nhãn", price: 0, category: "plus" },
  { id: "plus-khoi-blao", name: "PLUS - KHÓI B'LAO", price: 108000, category: "plus" },
  { id: "plus-matcha-coco", name: "PLUS - MATCHA COCO LATTE", price: 108000, category: "plus" },
  { id: "plus-lua-dao", name: "PLUS - LỤA ĐÀO", price: 108000, category: "plus" },
  { id: "plus-phong-lan", name: "PLUS - PHONG LAN", price: 108000, category: "plus" },
  { id: "plus-cold-brew", name: "PLUS - COLD BREW", price: 98182, category: "plus" },
  { id: "plus-da-lat", name: "PLUS - ĐÀ LẠT", price: 137455, category: "plus" },
  { id: "plus-dinh-phu-van", name: "PLUS - ĐỈNH PHÙ VÂN", price: 137455, category: "plus" },
  { id: "plus-tam", name: "PLUS - TẤM", price: 108000, category: "plus" },
  { id: "plus-o-long-nhai-sua", name: "PLUS - Ô LONG NHÀI SỮA", price: 108000, category: "plus" },
  { id: "plus-o-long-sua", name: "PLUS - Ô LONG SỮA PHÊ LA", price: 108000, category: "plus" },

  // MANG PHÊ LA VỀ NHÀ
  { id: "khan-lua-dao", name: "Khăn Lụa Đào - Phiên bản mới", price: 99000, category: "mang-ve" },
  { id: "bot-bien-o-long", name: "Bọt biển Phê La - Ô Long Sữa", price: 25000, category: "mang-ve" },
  { id: "bot-bien-latte", name: "Bọt biển Phê La - Phê Latte", price: 25000, category: "mang-ve" },
  { id: "bot-bien-gao-rang", name: "Bọt biển Phê La - Trân Châu Gạo Rang", price: 25000, category: "mang-ve" },
  { id: "bot-bien-phe-nau", name: "Bọt biển Phê La - Phê Nâu", price: 25000, category: "mang-ve" },
  { id: "bot-bien-xe-van", name: "Bọt biển Phê La - Xe Van", price: 25000, category: "mang-ve" },
  ...
  { id: "phin-giay-nguyen-ban", name: "Cà Phê Phin Giấy - Phê Nguyên Bản", price: 197000, category: "mang-ve" },
  ...
  { id: "phe-phin-nguyen-ban", name: "Phê Phin Nguyên Bản - Túi 200gr", price: 108000, category: "mang-ve" },
  ...
  { id: "o-long-mua-xuan", name: "Ô Long Mùa Xuân Đặc Sản - Túi 150gr", price: 344000, category: "mang-ve" },
